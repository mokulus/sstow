...
void create(struct dirlist* dl, const char* root_name, const char* target_name)
{
	struct stat sb;
	size_t i;
	for (i = 0; i < dl->size; ++i) {
...
void delete (struct dirlist* dl, const char* root_name, const char* target_name)
{
	struct stat sb;
	size_t i;
	for (i = 0; i < dl->size; ++i) {
